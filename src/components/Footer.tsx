        ...
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-12">
          <div className="col-span-1 md:col-span-2 lg:col-span-2">
            ...
            <p className="font-body text-brand-white/80 mt-6 max-w-sm leading-relaxed">
              London's creative marketplace for the odd, the rare, and the wonderful. We connect creators with local collectors to share extraordinary pieces.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2 font-body text-brand-white/80 text-sm">
              {categories.map((cat) => (
                  <li key={cat}>
                      <button onClick={() => router.push('/')} className="hover:text-brand-orange transition-colors text-left">{cat}</button>
                  </li>
              ))}
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-3 font-body text-brand-white/80 mb-8">
              <li><button onClick={() => router.push('/how-it-works')} className="hover:text-brand-orange transition-colors">How it works</button></li>
              <li><button onClick={() => router.push('/faq')} className="hover:text-brand-orange transition-colors">FAQ</button></li>
              <li><button onClick={() => router.push('/sustainability')} className="hover:text-brand-orange transition-colors">Sustainability</button></li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 font-body text-brand-white/80">
               <li><button onClick={() => router.push('/terms')} className="hover:text-brand-orange transition-colors">Terms of service</button></li>
              <li><button onClick={() => router.push('/privacy')} className="hover:text-brand-orange transition-colors">Privacy policy</button></li>
            </ul>

            <div className="mt-8">
                <h4 className="font-heading text-xl text-brand-yellow mb-4">Contact</h4>
                <button onClick={() => router.push('/contact')} className="font-body text-brand-white/80 hover:text-brand-orange transition-colors block mb-2">
                    Contact Us
                </button>
